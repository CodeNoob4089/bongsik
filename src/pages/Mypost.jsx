...
const CategoryButton = styled.button`
  ...
  background-color: ${(props) =>
    props.id === props.currentCategory ? "#FF4E50" : "white"};
  cursor: pointer;
`;
